...
| `manual-native` | **Available in 1.2.3**: Provides manual control over synchronization. Requires running manual commands. This option provides the best performance for macOs and Windows.                                                                                                                                                                                 |
